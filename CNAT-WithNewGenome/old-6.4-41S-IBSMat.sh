...
echo "angsd -b bams-filt -GL 1 $FILTERS $TODO -P 1 -out myresult" > runangsd
...
scp $LS6:$SCRATCH/LarvalGE/myresult50.ibsMat ./cnat_ibsMat-50
scp $LS6:$SCRATCH/LarvalGE/bams ./cnat_bams-50
